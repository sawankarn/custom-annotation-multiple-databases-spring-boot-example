...
@Configuration
@EnableJpaRepositories(basePackages = "youtube.java.puzzle",entityManagerFactoryRef = "entityManager")
public class DynamicDatabaseRouter {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder) {
        return builder.dataSource(dataSource()).packages("youtube.java.puzzle").build();
    }
